    ...
    <div className="flex items-center gap-2" ref={menuRef}>
      ...
      {user && !hideMyCoursesButton && (
        <button
          ...
          className={`inline-flex items-center justify-center gap-1.5 h-8 px-3 rounded-full border text-sm font-medium leading-none transition-all duration-200 shadow-sm hover:shadow-md ${
            isDark
      ...
      <div className="relative">
        ...
        className={`flex items-center justify-center w-8 h-8 rounded-full border-0 transition-all duration-200 overflow-hidden ${
          user
            ? profile?.avatar_url
