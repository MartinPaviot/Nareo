...
export default function WorkingPageMenu({ hideMyCoursesButton = false }: WorkingPageMenuProps) {
  ...
  return (
    <div className="flex items-center gap-2" ref={menuRef}>
      ...
      {/* Dropdown Menu */}
      {menuOpen && (
        <div className={`absolute top-full right-0 mt-2 w-72 border rounded-xl shadow-lg z-50 overflow-hidden ${
          isDark
            ...
            {user && (
              <div className={`px-4 py-3 border-b ${
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center flex-shrink-0 overflow-hidden relative">
                    {profile?.avatar_url ? (
                      <Image
                        src={profile.avatar_url}
                        alt="Avatar"
                  ...
                  <div className="min-w-0 flex-1">
                    {userName && (
                      <p className={`text-sm font-semibold truncate ${isDark ? 'text-neutral-100' : 'text-gray-900'}`}>
                        {userName}
                      </p>
                    )}
          ...
          <div className="flex flex-col p-3 gap-2">
            ...
            <button
              onClick={toggleTheme}
              className={`flex items-center justify-between h-11 px-4 rounded-xl text-sm font-medium transition-colors ${
                isDark
            ...
            >
              ...
              <span className={`w-10 h-6 rounded-full relative transition-colors ${isDark ? 'bg-orange-500' : 'bg-gray-200'}`}>
                <span className={`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-transform ${isDark ? 'right-1' : 'left-1'}`} />
              </span>
            </button>
            ...
            <div className={`border rounded-xl overflow-hidden ${
              ...
              <p className={`px-3 py-1.5 text-xs font-semibold flex items-center gap-2 ${
            ...
            {user ? (
              ...
              <>
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 h-11 px-4 rounded-xl bg-orange-500 text-white text-sm font-semibold hover:bg-orange-600 transition-colors"
                >
