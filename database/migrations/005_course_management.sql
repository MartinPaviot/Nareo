-- Migration 005: Course Management Features
-- Adds support for:
-- 1. Editable course titles
-- 2. Folders for organizing courses
-- 3. Cascade deletion of courses
...
-- Folder_courses: Users can manage courses in their own folders
...
comment on function delete_course_cascade is 'Safely deletes a course and all related data (chapters, questions, progress, folder associations)';
