  ...
  return [
    {
      ...
      content: [
        ...
        "MCQ quality rules:",
        "- All answer options must have similar length and level of detail. Avoid the pattern where the correct answer is noticeably longer or more detailed than distractors.",
        "- Distractors should be plausible and well-elaborated, not obviously wrong or too short.",
        "- Vary the position of the correct answer (not always first or last).",
        "Question fields:",
