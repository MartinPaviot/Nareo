...
$testFiles = @(
    "public/test_files/Beginner's guide - Cities_ Skylines Wiki.pdf",
    "public/test_files/Philosophy 101_ From Plato and Socrates to Ethics and Metaphysics, an Essential Primer on the History of Thought - PDFDrive.com.pdf",
    "public/test_files/Projet bac à sable.pdf",
    "public/test_files/philosophie (dragged).pdf",
    "public/test_files/Presentation Alter coloc Nov2024.docx"
)
...
if ($missingFiles.Count -gt 0) {
    Write-Host "`n❌ Missing files detected. Please ensure all test files are in public/test_files/" -ForegroundColor Red
    exit 1
}
